 ...
 *
 * Adds an additional validator for the phone number and marks form elements as
 * success when they are filled during registration.
 *
 * 1.0.0
 * - initial release
 *
...
namespace OstRegistrationValidation;

use Shopware\Components\Plugin;
use Shopware\Components\Plugin\Context;
use Symfony\Component\DependencyInjection\ContainerBuilder;

class OstRegistrationValidation extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_registration_validation.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_registration_validation.view_dir', $this->getPath() . '/Resources/views/');
